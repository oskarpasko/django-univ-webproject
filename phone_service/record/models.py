...
class Post(models.Model):
    ...
    def __str__(self):
        return f'{self.post_name}, {self.post_salary}'
...
class Service(models.Model):
    ...
    def __str__(self):
        return f'{self.service_id} | {self.service_name}, price: {self.service_price}'
...
class Record(models.Model):
    ...
    def __str__(self):
        return f'{self.record_id} | {self.record_client}, {self.record_service}, {self.record_start_date}, {self.record_deadline}'
